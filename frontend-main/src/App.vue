...
// 阅读状态管理
const readStatusKey = 'funchat_doc_last_read';
...
// 定义源地址常量
const GITHUB_BASE = 'https://raw.githubusercontent.com/Komorebi-yaodong/Funchat/main/';
const GITEE_BASE = 'https://gitee.com/Komorebi-yaodong/Funchat/raw/main/';
